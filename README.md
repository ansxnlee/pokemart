...
[Mikro-orm](https://github.com/mikro-orm/mikro-orm) is used to the generate SQL that talks with the database. Configuring mikro-orm.config.ts will be necessary to properly link the backend to one. 
